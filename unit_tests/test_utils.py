import os
import unittest
from rpd_tester.map_objects import *
from rpd_tester.utils import *

CORRECT_ANSWER_RPD_DIR = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "reference_rpds"
)
...
class TestUtilities(unittest.TestCase):
    ...
    def test_find_all_simple(self):
        ...
        correct_answer_path = os.path.join(
            CORRECT_ANSWER_RPD_DIR, "E-2.json"
        )
